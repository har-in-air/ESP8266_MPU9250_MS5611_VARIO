...
// i2c 7bit device address is 110 100[AD0]
...
#define MAG_FS_14BITS  	0x00 // 0.6 mGauss per LSB
#define MAG_FS_16BITS	0x01 // 0.15 mGauss per LSB


#define  MAG_ODR_8HZ  		0x02  
#define  MAG_ODR_100HZ  	0x06 
